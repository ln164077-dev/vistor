...
import { getOrCreateVisitorID, updateVisitorPage, checkIfBlocked, setupGlobalBlockedListener, checkBlockedAndBlock } from "@/lib/visitor-tracking"
...
export default function ComparisonPage() {
  ...
  // ─── Global Block Detection (Required for ALL pages) ───
  useEffect(() => {
        ...
        <div className="mb-4 md:mb-6">
          ...
          >
            <p className="text-blue-900 text-xs md:text-sm leading-relaxed">
              بموجب تعليمات مصرف قطر المركزي، يحق لحامل الوثيقة إلغاء الوثيقة واسترداد كامل المبلغ المدفوع خلال
